...
Require Export Sorensen.
Require Export FullSequent.
...
Section DialogFull.
  ...
  (* | AEq s t abs1 abs2 : attack_form (Eq s t) (Some (Pr (abs1[s .: ids]) (abs2[s .: ids]))) *)
  ...
  Proof.
    ...
    - apply Def with (phi := ⊤). reflexivity. inversion 1. intros. inversion atk.
